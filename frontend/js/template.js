...
function init_flot_chart() {
    ...
    for (var i = 0; i < 30; i++) {
        chart_plot_02_data.push([new Date(Date.today().add(i).days()).getTime(), randNum() + i + i +
            10]);
    }
...
function init_sparklines() {
    ...
    $(".sparkline_one").sparkline([2, 4, 3, 4, 5, 4, 5, 4, 3, 4, 5, 6, 4, 5, 6, 3, 5, 4, 5, 4, 5, 4,
        3, 4, 5, 6, 7, 5, 4, 3, 5, 6], {
        type: 'bar',
        height: '125',
        barWidth: 13,
        ...
        draw: function() {
            ...
            if (this.$.data('skin') == 'tron') {
                ...
                if (this.o.displayPrevious) {
                    ...
                    this.g.arc(this.xy, this.xy, this.radius - this.lineWidth, pa.s, pa
                        .e, pa.d);
                    this.g.stroke();
                }
...
function init_daterangepicker_right() {
    ...
    var cb = function(start, end, label) {
        console.log(start.toISOString(), end.toISOString(), label);
        $('#reportrange_right span').html(start.format('MMMM D, YYYY') + ' - ' + end.format(
            'MMMM D, YYYY'));
    };
    ...
    $('#reportrange_right span').html(moment().subtract(29, 'days').format('MMMM D, YYYY') + ' - ' +
        moment().format('MMMM D, YYYY'));
...
function init_echarts() {
    ...
    if ($('#echart_pyramid').length) {
        ...
        echartFunnel.setOption({
            ...
            legend: {
                data: ['Something #1', 'Something #2', 'Something #3', 'Something #4',
                    'Something #5'],
                orient: 'vertical',
                x: 'left',
                y: 'bottom'
